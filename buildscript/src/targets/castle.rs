...
//! Castle Wars is a strategic defense game mode.
//! Repository: https://github.com/Darkdustry-Coders/CastleWarsV8
...
simple_server_target!(
    ...
    fn setup_server(params) {
        params.run.link_global(
            params.root.join("castle/assets/PineForest.msav"),
            "castle/config/maps/PineForest.msav",
        );
    },
);
// use std::{
